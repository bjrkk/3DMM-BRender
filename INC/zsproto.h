...
typedef void BR_CALLBACK br_renderbounds_cbfn(
     ...
     */
    typedef void BR_CALLBACK br_primitive_cbfn(void *primitive, br_actor *actor, br_model *model, br_material *material,
                                               br_order_table *order_table, br_scalar z[3]);
    ...
    void BR_PUBLIC_ENTRY BrZsSceneRenderBegin(br_actor *world, br_actor *camera, br_pixelmap *colour_buffer,
                                              br_uint_8 db_index, br_uint_32 flags);
