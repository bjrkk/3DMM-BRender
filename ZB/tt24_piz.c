...
static inline void __TRAPEZOID_PIZ2_RGB_888(struct scan_edge *edge, br_boolean is_forward, br_fixed_ls *z_val, br_int_32 *fb_index) {
...
static inline void __TRAPEZOID_PIZ2I_RGB_888(struct scan_edge *edge, br_boolean is_forward, br_fixed_ls *z_val, br_int_32 *fb_index) {
	br_int_32 endptr = edge->i;
...
void BR_ASM_CALL RawTriangle_PIZ2_RGB_888(struct temp_vertex_fixed *v0, struct temp_vertex_fixed *v1, struct temp_vertex_fixed *v2) {
...
void BR_ASM_CALL RawTriangle_PIZ2I_RGB_888(struct temp_vertex_fixed *v0, struct temp_vertex_fixed *v1, struct temp_vertex_fixed *v2) {
	struct temp_vertex_fixed *a, *b, *c;
	a = v0; 
	b = v1; 
	c = v2;
...
void BR_ASM_CALL TriangleRenderPIZ2_RGB_888(struct temp_vertex_fixed *v0, struct temp_vertex_fixed *v1, struct temp_vertex_fixed *v2) {
	RawTriangle_PIZ2_RGB_888(v0, v1, v2);
}

void BR_ASM_CALL TriangleRenderPIZ2I_RGB_888(struct temp_vertex_fixed *v0, struct temp_vertex_fixed *v1, struct temp_vertex_fixed *v2) {
