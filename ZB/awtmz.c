...
inline void TriangleRender_Generic_AWTMI(struct temp_vertex_fixed *a, struct temp_vertex_fixed *b, struct temp_vertex_fixed *c, br_boolean use_z_buffer, br_uint_32 bpp, TrapezoidRenderCall trapezoid_render, br_boolean use_bump, br_boolean use_light) {
	/* 
...
void BR_ASM_CALL TriangleRenderPIZ2TAN(struct temp_vertex_fixed *a, struct temp_vertex_fixed *b, struct temp_vertex_fixed *c) {
...
void BR_ASM_CALL TriangleRenderPIZ2TAN_RGB_555(struct temp_vertex_fixed *a, struct temp_vertex_fixed *b, struct temp_vertex_fixed *c) {
...
void BR_ASM_CALL TriangleRenderPIZ2TAN_RGB_888(struct temp_vertex_fixed *a, struct temp_vertex_fixed *b, struct temp_vertex_fixed *c) {
