...
static char rscid[] = "$Id: quat.c 1.11 1995/02/22 21:42:28 sam Exp $";
...
br_quat *BR_PUBLIC_ENTRY BrQuatSlerp(br_quat *q, br_quat *l, br_quat *r, br_scalar a, br_int_16 spins)
{
