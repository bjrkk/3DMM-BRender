...
typedef struct {
	...
	br_uint_8 glyph_W[FONT_HEIGHT * 2];
...
__font_glyphs _FontProp7x9_Glyphs = {
	.glyph_space = {
		0b00000000,
		0b00000000,
		0b00000000,
...
br_uint_16 _FontProp7x9_Encoding[] = {
	offsetof(__font_glyphs, glyph_space),
	offsetof(__font_glyphs, glyph_space),
	offsetof(__font_glyphs, glyph_space),
	offsetof(__font_glyphs, glyph_space),
	offsetof(__font_glyphs, glyph_space),
	offsetof(__font_glyphs, glyph_space),
	offsetof(__font_glyphs, glyph_space),
	offsetof(__font_glyphs, glyph_bullet),
	offsetof(__font_glyphs, glyph_space),
	offsetof(__font_glyphs, glyph_space),
	offsetof(__font_glyphs, glyph_space),
	offsetof(__font_glyphs, glyph_space),
	...
	offsetof(__font_glyphs, glyph_space),
	offsetof(__font_glyphs, glyph_space),
	offsetof(__font_glyphs, glyph_uparrow),
	offsetof(__font_glyphs, glyph_downarrow),
	offsetof(__font_glyphs, glyph_rightarrow),
	offsetof(__font_glyphs, glyph_leftarrow),
	offsetof(__font_glyphs, glyph_space),
	offsetof(__font_glyphs, glyph_space),
	offsetof(__font_glyphs, glyph_uparrow),
	offsetof(__font_glyphs, glyph_downarrow),
	offsetof(__font_glyphs, glyph_space),
	offsetof(__font_glyphs, glyph_exclam),
	offsetof(__font_glyphs, glyph_dquote),
	offsetof(__font_glyphs, glyph_hash),
	offsetof(__font_glyphs, glyph_pound),
	offsetof(__font_glyphs, glyph_percent),
	offsetof(__font_glyphs, glyph_ampersand),
	offsetof(__font_glyphs, glyph_quote),
	offsetof(__font_glyphs, glyph_lparen),
	offsetof(__font_glyphs, glyph_rparen),
	offsetof(__font_glyphs, glyph_asterisk),
	offsetof(__font_glyphs, glyph_plus),
	offsetof(__font_glyphs, glyph_comma),
	offsetof(__font_glyphs, glyph_minus),
	offsetof(__font_glyphs, glyph_period),
	offsetof(__font_glyphs, glyph_slash),
	offsetof(__font_glyphs, glyph_0),
	offsetof(__font_glyphs, glyph_1),
	offsetof(__font_glyphs, glyph_2),
	offsetof(__font_glyphs, glyph_3),
	offsetof(__font_glyphs, glyph_4),
	offsetof(__font_glyphs, glyph_5),
	offsetof(__font_glyphs, glyph_6),
	offsetof(__font_glyphs, glyph_7),
	offsetof(__font_glyphs, glyph_8),
	offsetof(__font_glyphs, glyph_9),
	offsetof(__font_glyphs, glyph_colon),
	offsetof(__font_glyphs, glyph_semicolon),
	offsetof(__font_glyphs, glyph_langle),
	offsetof(__font_glyphs, glyph_equal),
	offsetof(__font_glyphs, glyph_rangle),
	offsetof(__font_glyphs, glyph_query),
	offsetof(__font_glyphs, glyph_comat),
	offsetof(__font_glyphs, glyph_A),
	offsetof(__font_glyphs, glyph_B),
	offsetof(__font_glyphs, glyph_C),
	offsetof(__font_glyphs, glyph_D),
	offsetof(__font_glyphs, glyph_E),
	offsetof(__font_glyphs, glyph_F),
	offsetof(__font_glyphs, glyph_G),
	offsetof(__font_glyphs, glyph_H),
	offsetof(__font_glyphs, glyph_I),
	offsetof(__font_glyphs, glyph_J),
	offsetof(__font_glyphs, glyph_K),
	offsetof(__font_glyphs, glyph_L),
	offsetof(__font_glyphs, glyph_M),
	offsetof(__font_glyphs, glyph_N),
	offsetof(__font_glyphs, glyph_O),
	offsetof(__font_glyphs, glyph_P),
	offsetof(__font_glyphs, glyph_Q),
	offsetof(__font_glyphs, glyph_R),
	offsetof(__font_glyphs, glyph_S),
	offsetof(__font_glyphs, glyph_T),
	offsetof(__font_glyphs, glyph_U),
	offsetof(__font_glyphs, glyph_V),
	offsetof(__font_glyphs, glyph_W),
	offsetof(__font_glyphs, glyph_X),
	offsetof(__font_glyphs, glyph_Y),
	offsetof(__font_glyphs, glyph_Z),
	offsetof(__font_glyphs, glyph_lsquare),
	offsetof(__font_glyphs, glyph_bslash),
	offsetof(__font_glyphs, glyph_rsquare),
	offsetof(__font_glyphs, glyph_caret),
	offsetof(__font_glyphs, glyph_underbar),
	offsetof(__font_glyphs, glyph_bquote),
	offsetof(__font_glyphs, glyph_a),
	offsetof(__font_glyphs, glyph_b),
	offsetof(__font_glyphs, glyph_c),
	offsetof(__font_glyphs, glyph_d),
	...
	offsetof(__font_glyphs, glyph_y),
	offsetof(__font_glyphs, glyph_z),
	offsetof(__font_glyphs, glyph_lbrace),
	offsetof(__font_glyphs, glyph_vbar),
	offsetof(__font_glyphs, glyph_rbrace),
	offsetof(__font_glyphs, glyph_tilde),
	offsetof(__font_glyphs, glyph_arrow),
	offsetof(__font_glyphs, glyph_space),
	offsetof(__font_glyphs, glyph_space),
	offsetof(__font_glyphs, glyph_space),
	offsetof(__font_glyphs, glyph_space),
	...
	offsetof(__font_glyphs, glyph_space),
	offsetof(__font_glyphs, glyph_space),
	offsetof(__font_glyphs, glyph_ld_tb),
	offsetof(__font_glyphs, glyph_ld_tbl),
	offsetof(__font_glyphs, glyph_ld_tbL),
	offsetof(__font_glyphs, glyph_ld_TBl),
	offsetof(__font_glyphs, glyph_ld_Bl),
	offsetof(__font_glyphs, glyph_ld_bL),
	offsetof(__font_glyphs, glyph_ld_TBL),
	offsetof(__font_glyphs, glyph_ld_TB),
	offsetof(__font_glyphs, glyph_ld_BL),
	offsetof(__font_glyphs, glyph_ld_TL),
	offsetof(__font_glyphs, glyph_ld_Tl),
	offsetof(__font_glyphs, glyph_ld_tL),
	offsetof(__font_glyphs, glyph_ld_bl),
	offsetof(__font_glyphs, glyph_ld_tr),
	offsetof(__font_glyphs, glyph_ld_tlr),
	offsetof(__font_glyphs, glyph_ld_blr),
	offsetof(__font_glyphs, glyph_ld_tbr),
	offsetof(__font_glyphs, glyph_ld_lr),
	offsetof(__font_glyphs, glyph_ld_tblr),
	offsetof(__font_glyphs, glyph_ld_tbR),
	offsetof(__font_glyphs, glyph_ld_TBr),
	offsetof(__font_glyphs, glyph_ld_TR),
	offsetof(__font_glyphs, glyph_ld_BR),
	offsetof(__font_glyphs, glyph_ld_TLR),
	offsetof(__font_glyphs, glyph_ld_BLR),
	offsetof(__font_glyphs, glyph_ld_TBR),
	offsetof(__font_glyphs, glyph_ld_LR),
	...
	offsetof(__font_glyphs, glyph_space),
	offsetof(__font_glyphs, glyph_space),
	offsetof(__font_glyphs, glyph_alpha),
	offsetof(__font_glyphs, glyph_space),
	offsetof(__font_glyphs, glyph_space),
	offsetof(__font_glyphs, glyph_space),
	offsetof(__font_glyphs, glyph_space),
	...
	offsetof(__font_glyphs, glyph_space),
	offsetof(__font_glyphs, glyph_space),
	offsetof(__font_glyphs, glyph_degree),
	offsetof(__font_glyphs, glyph_space),
	offsetof(__font_glyphs, glyph_space),
	offsetof(__font_glyphs, glyph_tick),
	offsetof(__font_glyphs, glyph_space),
	offsetof(__font_glyphs, glyph_sup2),
	offsetof(__font_glyphs, glyph_space),
	offsetof(__font_glyphs, glyph_space),
};

br_int_8 _FontProp7x9_Widths[] = {
	3, /* glyph_space */
	3, /* glyph_space */
	3, /* glyph_space */
	3, /* glyph_space */
...
struct br_font _FontProp7x9 = {
	.flags = BR_FONTF_PROPORTIONAL,
	.glyph_x = FONT_WIDTH,
	.glyph_y = FONT_HEIGHT,
	.spacing_x = 4,
	.spacing_y = 6,
	.width = _FontProp7x9_Widths,
	.encoding = _FontProp7x9_Encoding,
	.glyphs = (br_uint_8*)&_FontProp7x9_Glyphs
};