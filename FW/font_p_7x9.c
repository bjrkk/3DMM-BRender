...
__font_glyphs _FontProp7x9_Glyphs = {
    ...
    .glyph_Q = {0b00111000, 0b01000100, 0b10000010, 0b10000010, 0b10000010, 0b01000100, 0b00111000, 0b00001110,
                0b00000000},
    .glyph_R =
        {
            0b11110000,
...
struct br_font _FontProp7x9 = {.flags = BR_FONTF_PROPORTIONAL,
                               .glyph_x = FONT_WIDTH,
                               .glyph_y = FONT_HEIGHT,
                               .spacing_x = 4,
                               .spacing_y = 6,
